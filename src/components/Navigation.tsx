...
import logo from "@/assets/evolink-logo.jpg";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-black/95 backdrop-blur supports-[backdrop-filter]:bg-black/90">
      <nav className="container mx-auto flex h-16 items-center justify-between px-4">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link to="/create" className="text-sm font-medium text-white hover:text-primary transition-colors">
            Start a Project
          </Link>
          <Link to="/how-it-works" className="text-sm font-medium text-white hover:text-primary transition-colors">
            How It Works
          </Link>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <Button variant="outline" className="text-white border-white/30 hover:bg-white/10 hover:text-primary">Sign In</Button>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="md:hidden border-t border-white/10 bg-black animate-slide-up">
          <div className="container mx-auto px-4 py-4 space-y-4">
            ...
            <div className="pt-4 space-y-2">
              <Button variant="outline" className="w-full text-white border-white/30 hover:bg-white/10 hover:text-primary">
                Sign In
              </Button>
